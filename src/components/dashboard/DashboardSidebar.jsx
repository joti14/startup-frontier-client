...
export default function DashboardSideBar({ onPremiumTrigger }) {
  ...
  return (
    <aside className="w-64 h-screen border-r border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-slate-950 flex flex-col z-20 shrink-0 overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-900 bg-slate-50/[0.3] dark:bg-slate-900/[0.15] shrink-0">
      ...
      <nav className="flex-grow overflow-y-auto px-3 py-5 space-y-1 custom-scrollbar">
      ...
      <div className="px-3 py-1.5 border-t border-slate-100 dark:border-slate-900 space-y-1 shrink-0 bg-white dark:bg-slate-950">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-bold text-amber-700 bg-amber-500/5 hover:bg-amber-500/10 dark:text-amber-400 dark:bg-amber-500/[0.03] transition-all duration-200 cursor-pointer border border-amber-500/10 group"
        >
        ...
        >
          <span className="w-7 h-7 rounded-lg bg-slate-100 dark:bg-slate-900 text-slate-400 flex items-center justify-center shrink-0 text-current">
            <LogOut size={14} />
          </span>
          Sign Out
        </button>
